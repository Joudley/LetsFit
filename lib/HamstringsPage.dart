...
class HamstringsPage extends StatefulWidget {
  @override
  _HamstringsPageState createState() => _HamstringsPageState();
}

class _HamstringsPageState extends State<HamstringsPage> {
    ...
    try {
      ...
      setState(() {
        exercises = exercisesJson
            ...
            .where((exercise) => exercise.muscle == 'hamstrings')
            .toList();
      });
    } catch (error) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Hamstrings exercices'),
      ),
