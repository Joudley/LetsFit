...
class CalvesPage extends StatefulWidget {
  @override
  _CalvesPageState createState() => _CalvesPageState();
}

class _CalvesPageState extends State<CalvesPage> {
    ...
    try {
      ...
      setState(() {
        exercises = exercisesJson
            ...
            .where((exercise) => exercise.muscle == 'calves')
            .toList();
      });
    } catch (error) {
