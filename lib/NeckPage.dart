...
class NeckPage extends StatefulWidget {
  @override
  _NeckPageState createState() => _NeckPageState();
}

class _NeckPageState extends State<NeckPage> {
    ...
    try {
      ...
      setState(() {
        exercises = exercisesJson
            ...
            .where((exercise) => exercise.muscle == 'neck')
            .toList();
      });
    } catch (error) {
