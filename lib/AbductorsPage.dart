...
class AbductorsPage extends StatefulWidget {
  @override
  _AbductorsPageState createState() => _AbductorsPageState();
}

class _AbductorsPageState extends State<AbductorsPage> {
    ...
    try {
      ...
      setState(() {
        exercises = exercisesJson
            ...
            .where((exercise) => exercise.muscle == 'abductors')
            .toList();
      });
    } catch (error) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Abductors exercices'),
      ),
