...
class TrapsPage extends StatefulWidget {
  @override
  _TrapsPageState createState() => _TrapsPageState();
}

class _TrapsPageState extends State<TrapsPage> {
    ...
    try {
      ...
      setState(() {
        exercises = exercisesJson
            ...
            .where((exercise) => exercise.muscle == 'traps')
            .toList();
      });
    } catch (error) {
