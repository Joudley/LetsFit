...
class AbdominalsPage extends StatefulWidget {
  @override
  _AbdominalsPageState createState() => _AbdominalsPageState();
}

class _AbdominalsPageState extends State<AbdominalsPage> {
    ...
    try {
      ...
      setState(() {
        exercises = exercisesJson
            ...
            .where((exercise) => exercise.muscle == 'abdominals')
            .toList();
      });
    } catch (error) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Abdominals exercices'),
      ),
